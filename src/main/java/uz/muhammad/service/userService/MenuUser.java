package uz.muhammad.service.userService;

import uz.muhammad.database.Database;
import uz.muhammad.exception.FullUser;
import uz.muhammad.exception.IndexOutOf;
...
public class MenuUser {
    ...
    public void mainMenu(){
        ...
        while (true){
            util.clear();
            util.green(util.middle("User menu"));
        ...
        for (Library library : db.libraries) {
            for (Book book : library.getBooks()) {
                if(book.getName().equals(bookName)){
                    ...
                    util.green(util.middle("Successfully got"));
                    util.pause();
                    db.setUsers();
                    db.setLibraries();
                    db.getBooks();
    ...
    private void showMyBooks() {
        util.clear();
        util.yellow(util.middle("My books"));
        System.out.println();
        ...
        for (Library library : db.libraries) {
            for (Book book : library.getBooks()) {
                if(book.getName().equals(bookName)){
                    ...
                    db.getBooks();
                    db.setBooks();
                    util.green(util.middle("Successfully returned"));
                    util.pause();
                    return;
                }
            }
